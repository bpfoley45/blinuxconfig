...
I use Ansible to configure all of my desktops, laptops, and servers. I use the Ansible Pull method, it's fully automated, and scripts everything from system services to GNOME desktop settings.
...
ansible-pull -U git@github.com:bpfoley45/blinuxconfig.git
